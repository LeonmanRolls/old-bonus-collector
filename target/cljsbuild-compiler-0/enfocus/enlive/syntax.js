...
,sel_to_str(item));var iter__3973__auto__ = (function iter__20243(s__20244){return (new cljs.core.LazySeq(null,(function (){var s__20244__$1 = s__20244;while(true){
var temp__4092__auto__ = cljs.core.seq(s__20244__$1);if(temp__4092__auto__)
{var xs__4579__auto__ = temp__4092__auto__;var s = cljs.core.first(xs__4579__auto__);var iterys__3969__auto__ = ((function (s__20244__$1,s,xs__4579__auto__,temp__4092__auto__){
return (function iter__20245(s__20246){return (new cljs.core.LazySeq(null,((function (s__20244__$1,s,xs__4579__auto__,temp__4092__auto__){
return (function (){var s__20246__$1 = s__20246;while(true){
var temp__4092__auto____$1 = cljs.core.seq(s__20246__$1);if(temp__4092__auto____$1)
{var s__20246__$2 = temp__4092__auto____$1;if(cljs.core.chunked_seq_QMARK_(s__20246__$2))
{var c__3971__auto__ = cljs.core.chunk_first(s__20246__$2);var size__3972__auto__ = cljs.core.count(c__3971__auto__);var b__20248 = cljs.core.chunk_buffer(size__3972__auto__);if((function (){var i__20247 = 0;while(true){
if((i__20247 < size__3972__auto__))
{var e = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__3971__auto__,i__20247);cljs.core.chunk_append(b__20248,(function (){cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([s,e], 0));
...
{return cljs.core.chunk_cons(cljs.core.chunk(b__20248),iter__20245(cljs.core.chunk_rest(s__20246__$2)));
} else
{return cljs.core.chunk_cons(cljs.core.chunk(b__20248),null);
}
} else
{var e = cljs.core.first(s__20246__$2);return cljs.core.cons((function (){cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([s,e], 0));
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(e,s);
})(),iter__20245(cljs.core.rest(s__20246__$2)));
}
} else
{return null;
}
...
});})(s__20244__$1,s,xs__4579__auto__,temp__4092__auto__))
,null,null));
});})(s__20244__$1,s,xs__4579__auto__,temp__4092__auto__))
;var fs__3970__auto__ = cljs.core.seq(iterys__3969__auto__(end));if(fs__3970__auto__)
{return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__3970__auto__,iter__20243(cljs.core.rest(s__20244__$1)));
} else
{{
var G__20250 = cljs.core.rest(s__20244__$1);
s__20244__$1 = G__20250;
continue;
}
}
} else
...
enfocus.enlive.syntax.attr_pairs = (function attr_pairs(op,elms){var ts = (function (p__20253){var vec__20254 = p__20253;var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20254,0,null);var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20254,1,null);return [cljs.core.str("["),cljs.core.str(cljs.core.name(x)),cljs.core.str(op),cljs.core.str("='"),cljs.core.str(y),cljs.core.str("']")].join('');
...
attr_QMARK_.cljs$lang$applyTo = (function (arglist__20255){
var elms = cljs.core.seq(arglist__20255);
...
attr_has.cljs$lang$applyTo = (function (arglist__20257){
var x = cljs.core.first(arglist__20257);
var vals = cljs.core.rest(arglist__20257);
...
attr_starts.cljs$lang$applyTo = (function (arglist__20258){
var elms = cljs.core.seq(arglist__20258);
...
attr_ends.cljs$lang$applyTo = (function (arglist__20259){
var elms = cljs.core.seq(arglist__20259);
...
attr_contains.cljs$lang$applyTo = (function (arglist__20260){
...
attr_BAR__EQ_.cljs$lang$applyTo = (function (arglist__20261){
var elms = cljs.core.seq(arglist__20261);
...
but.cljs$lang$applyTo = (function (arglist__20262){
var sel = cljs.core.seq(arglist__20262);
