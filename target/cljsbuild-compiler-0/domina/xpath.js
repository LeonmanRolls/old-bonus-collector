...
{{
var G__20229 = (i + 1);
var G__20230 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__20229;
acc = G__20230;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t20234 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t20234 = (function (expr,base,xpath,meta20235){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t20234.cljs$lang$type = true;
domina.xpath.t20234.cljs$lang$ctorStr = "domina.xpath/t20234";
domina.xpath.t20234.cljs$lang$ctorPrWriter = (function (this__3824__auto__,writer__3825__auto__,opt__3826__auto__){return cljs.core._write(writer__3825__auto__,"domina.xpath/t20234");
});
domina.xpath.t20234.prototype.domina$DomContent$ = true;
domina.xpath.t20234.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t20234.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t20234.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20236){var self__ = this;
var _20236__$1 = this;return self__.meta20235;
});
domina.xpath.t20234.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20236,meta20235__$1){var self__ = this;
var _20236__$1 = this;return (new domina.xpath.t20234(self__.expr,self__.base,self__.xpath,meta20235__$1));
});
domina.xpath.__GT_t20234 = (function __GT_t20234(expr__$1,base__$1,xpath__$1,meta20235){return (new domina.xpath.t20234(expr__$1,base__$1,xpath__$1,meta20235));
});
}
return (new domina.xpath.t20234(expr,base,xpath,null));
});
