...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15574 = 0;while(true){
var m_15575 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15575 == null))
{} else
{m_15575.call(null);
if((count_15574 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15576 = (count_15574 + 1);
count_15574 = G__15576;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__4988__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__4988__auto__)
