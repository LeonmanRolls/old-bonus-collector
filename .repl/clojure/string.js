...
{{
var G__15544 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15544;
continue;
}
} else
...
{var pred__15548 = cljs.core._EQ_;var expr__15549 = limit;if(cljs.core.truth_(pred__15548.call(null,1,expr__15549)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15548.call(null,2,expr__15549)))
...
var G__15551 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15552 = (limit__$1 - 1);
var G__15553 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15551;
limit__$1 = G__15552;
parts = G__15553;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___15555 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___15555))
{var replacement_15556 = temp__4090__auto___15555;buffer.append([cljs.core.str(replacement_15556)].join(''));
} else
{buffer.append(ch);
}
{
var G__15557 = (index + 1);
index = G__15557;
continue;
}
}
