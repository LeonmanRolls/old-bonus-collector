...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_19925 = 0;while(true){
var m_19926 = cljs.core.async.impl.dispatch.tasks.pop();if((m_19926 == null))
{} else
{m_19926.call(null);
if((count_19925 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__19927 = (count_19925 + 1);
count_19925 = G__19927;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7466__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7466__auto__)
