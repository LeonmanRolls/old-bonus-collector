...
{{
var G__12882 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12882;
continue;
}
} else
...
{var pred__12886 = cljs.core._EQ_;var expr__12887 = limit;if(cljs.core.truth_(pred__12886.call(null,1,expr__12887)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12886.call(null,2,expr__12887)))
...
var G__12889 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12890 = (limit__$1 - 1);
var G__12891 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12889;
limit__$1 = G__12890;
parts = G__12891;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___12893 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12893))
{var replacement_12894 = temp__4090__auto___12893;buffer.append([cljs.core.str(replacement_12894)].join(''));
} else
{buffer.append(ch);
}
{
