...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t23027 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t23027 = (function (val,box,meta23028){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t23027.cljs$lang$type = true;
cljs.core.async.impl.channels.t23027.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t23027";
cljs.core.async.impl.channels.t23027.cljs$lang$ctorPrWriter = (function (this__3824__auto__,writer__3825__auto__,opt__3826__auto__){return cljs.core._write(writer__3825__auto__,"cljs.core.async.impl.channels/t23027");
});
cljs.core.async.impl.channels.t23027.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t23027.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23029){var self__ = this;
var _23029__$1 = this;return self__.meta23028;
});
cljs.core.async.impl.channels.t23027.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23029,meta23028__$1){var self__ = this;
var _23029__$1 = this;return (new cljs.core.async.impl.channels.t23027(self__.val,self__.box,meta23028__$1));
});
cljs.core.async.impl.channels.__GT_t23027 = (function __GT_t23027(val__$1,box__$1,meta23028){return (new cljs.core.async.impl.channels.t23027(val__$1,box__$1,meta23028));
});
}
return (new cljs.core.async.impl.channels.t23027(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_23030 = self__.takes.pop();if((taker_23030 == null))
{} else
{if(taker_23030.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_23031 = taker_23030.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_23031,taker_23030){
return (function (){return (take_cb_23031.cljs$core$IFn$_invoke$arity$1 ? take_cb_23031.cljs$core$IFn$_invoke$arity$1(null) : take_cb_23031.call(null,null));
});})(take_cb_23031,taker_23030))
);
} else
{}
{
