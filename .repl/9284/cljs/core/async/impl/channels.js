...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15580 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15580 = (function (val,box,meta15581){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t15580.cljs$lang$type = true;
cljs.core.async.impl.channels.t15580.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15580";
cljs.core.async.impl.channels.t15580.cljs$lang$ctorPrWriter = (function (this__5539__auto__,writer__5540__auto__,opt__5541__auto__){return cljs.core._write.call(null,writer__5540__auto__,"cljs.core.async.impl.channels/t15580");
});
cljs.core.async.impl.channels.t15580.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15580.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15582){var self__ = this;
var _15582__$1 = this;return self__.meta15581;
});
cljs.core.async.impl.channels.t15580.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15582,meta15581__$1){var self__ = this;
var _15582__$1 = this;return (new cljs.core.async.impl.channels.t15580(self__.val,self__.box,meta15581__$1));
});
cljs.core.async.impl.channels.__GT_t15580 = (function __GT_t15580(val__$1,box__$1,meta15581){return (new cljs.core.async.impl.channels.t15580(val__$1,box__$1,meta15581));
});
}
return (new cljs.core.async.impl.channels.t15580(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__5542__auto__,writer__5543__auto__,opts__5544__auto__){return cljs.core._write.call(null,writer__5543__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__5539__auto__,writer__5540__auto__,opt__5541__auto__){return cljs.core._write.call(null,writer__5540__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_15583 = self__.takes.pop();if((taker_15583 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15583))
{var take_cb_15584 = cljs.core.async.impl.protocols.commit.call(null,taker_15583);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15584,taker_15583){
return (function (){return take_cb_15584.call(null,null);
});})(take_cb_15584,taker_15583))
);
} else
{}
{
