...
{{
var G__37040 = (i + 1);
var G__37041 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__37040;
acc = G__37041;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t37045 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t37045 = (function (expr,base,xpath,meta37046){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t37045.cljs$lang$type = true;
domina.xpath.t37045.cljs$lang$ctorStr = "domina.xpath/t37045";
domina.xpath.t37045.cljs$lang$ctorPrWriter = (function (this__3824__auto__,writer__3825__auto__,opt__3826__auto__){return cljs.core._write(writer__3825__auto__,"domina.xpath/t37045");
});
domina.xpath.t37045.prototype.domina$DomContent$ = true;
domina.xpath.t37045.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t37045.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t37045.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37047){var self__ = this;
var _37047__$1 = this;return self__.meta37046;
});
domina.xpath.t37045.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37047,meta37046__$1){var self__ = this;
var _37047__$1 = this;return (new domina.xpath.t37045(self__.expr,self__.base,self__.xpath,meta37046__$1));
});
domina.xpath.__GT_t37045 = (function __GT_t37045(expr__$1,base__$1,xpath__$1,meta37046){return (new domina.xpath.t37045(expr__$1,base__$1,xpath__$1,meta37046));
});
}
return (new domina.xpath.t37045(expr,base,xpath,null));
});
