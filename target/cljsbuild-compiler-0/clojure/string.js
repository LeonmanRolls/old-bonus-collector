...
{{
var G__23252 = cljs.core.pop(v__$1);
v__$1 = G__23252;
continue;
}
} else
...
{var pred__23256 = cljs.core._EQ_;var expr__23257 = limit;if(cljs.core.truth_((pred__23256.cljs$core$IFn$_invoke$arity$2 ? pred__23256.cljs$core$IFn$_invoke$arity$2(1,expr__23257) : pred__23256.call(null,1,expr__23257))))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((pred__23256.cljs$core$IFn$_invoke$arity$2 ? pred__23256.cljs$core$IFn$_invoke$arity$2(2,expr__23257) : pred__23256.call(null,2,expr__23257))))
...
var G__23259 = s__$1.substring((index + cljs.core.count(m)));
var G__23260 = (limit__$1 - 1);
var G__23261 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring(0,index));
s__$1 = G__23259;
limit__$1 = G__23260;
parts = G__23261;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___23263 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4090__auto___23263))
{var replacement_23264 = temp__4090__auto___23263;buffer.append([cljs.core.str(replacement_23264)].join(''));
} else
{buffer.append(ch);
}
{
var G__23265 = (index + 1);
index = G__23265;
continue;
}
}
