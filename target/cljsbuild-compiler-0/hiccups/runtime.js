...
hiccups.runtime._STAR_html_mode_STAR_ = cljs.core.constant$keyword$73;
hiccups.runtime.xml_mode_QMARK_ = (function xml_mode_QMARK_(){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(hiccups.runtime._STAR_html_mode_STAR_,cljs.core.constant$keyword$73);
});
hiccups.runtime.in_mode = (function in_mode(mode,f){var _STAR_html_mode_STAR_23267 = hiccups.runtime._STAR_html_mode_STAR_;try{hiccups.runtime._STAR_html_mode_STAR_ = mode;
return (f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_23267;
}});
/**
...
hiccups.runtime.render_attribute = (function render_attribute(p__23268){var vec__23270 = p__23268;var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23270,0,null);var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23270,1,null);if(value === true)
...
*/
hiccups.runtime.normalize_element = (function normalize_element(p__23271){var vec__23274 = p__23271;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23274,0,null);var content = cljs.core.nthnext(vec__23274,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else
{}
var vec__23275 = cljs.core.re_matches(hiccups.runtime.re_tag,hiccups.runtime.as_str(tag));var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23275,0,null);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23275,1,null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23275,2,null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23275,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$20,id,cljs.core.constant$keyword$70,(cljs.core.truth_(class$)?clojure.string.replace(class$,"."," "):null)], null);var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
...
*/
hiccups.runtime.render_element = (function render_element(element){var vec__23277 = hiccups.runtime.normalize_element(element);var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23277,0,null);var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23277,1,null);var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23277,2,null);if(cljs.core.truth_((function (){var or__3285__auto__ = content;if(cljs.core.truth_(or__3285__auto__))
