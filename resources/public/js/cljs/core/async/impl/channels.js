...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t40352 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t40352 = (function (val,box,meta40353){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t40352.cljs$lang$type = true;
cljs.core.async.impl.channels.t40352.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t40352";
cljs.core.async.impl.channels.t40352.cljs$lang$ctorPrWriter = (function (this__3824__auto__,writer__3825__auto__,opt__3826__auto__){return cljs.core._write(writer__3825__auto__,"cljs.core.async.impl.channels/t40352");
});
cljs.core.async.impl.channels.t40352.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t40352.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40354){var self__ = this;
var _40354__$1 = this;return self__.meta40353;
});
cljs.core.async.impl.channels.t40352.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40354,meta40353__$1){var self__ = this;
var _40354__$1 = this;return (new cljs.core.async.impl.channels.t40352(self__.val,self__.box,meta40353__$1));
});
cljs.core.async.impl.channels.__GT_t40352 = (function __GT_t40352(val__$1,box__$1,meta40353){return (new cljs.core.async.impl.channels.t40352(val__$1,box__$1,meta40353));
});
}
return (new cljs.core.async.impl.channels.t40352(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3827__auto__,writer__3828__auto__,opts__3829__auto__){return cljs.core._write(writer__3828__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3824__auto__,writer__3825__auto__,opt__3826__auto__){return cljs.core._write(writer__3825__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_40355 = self__.takes.pop();if((taker_40355 == null))
{} else
{if(taker_40355.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_40356 = taker_40355.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_40356,taker_40355){
return (function (){return (take_cb_40356.cljs$core$IFn$_invoke$arity$1 ? take_cb_40356.cljs$core$IFn$_invoke$arity$1(null) : take_cb_40356.call(null,null));
});})(take_cb_40356,taker_40355))
);
} else
{}
{
...
{var put_cb = put_handler.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);var _ = handler.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (put_cb,_,put_handler,val,putter){
