...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj12842 = {};return obj12842;
})();
cljs.reader.read_char = (function read_char(reader){if((function (){var and__4988__auto__ = reader;if(and__4988__auto__)
...
{var x__5598__auto__ = (((reader == null))?null:reader);return (function (){var or__5000__auto__ = (cljs.reader.read_char[goog.typeOf(x__5598__auto__)]);if(or__5000__auto__)
{return or__5000__auto__;
} else
{var or__5000__auto____$1 = (cljs.reader.read_char["_"]);if(or__5000__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__4988__auto__ = reader;if(and__4988__auto__)
...
{var x__5598__auto__ = (((reader == null))?null:reader);return (function (){var or__5000__auto__ = (cljs.reader.unread[goog.typeOf(x__5598__auto__)]);if(or__5000__auto__)
{return or__5000__auto__;
} else
{var or__5000__auto____$1 = (cljs.reader.unread["_"]);if(or__5000__auto____$1)
{return or__5000__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__5539__auto__,writer__5540__auto__,opt__5541__auto__){return cljs.core._write.call(null,writer__5540__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__5000__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__5000__auto__))
{return or__5000__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__12843){
var rdr = cljs.core.first(arglist__12843);
var msg = cljs.core.rest(arglist__12843);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__4988__auto__ = !((ch === "#"));if(and__4988__auto__)
{var and__4988__auto____$1 = !((ch === "'"));if(and__4988__auto____$1)
{var and__4988__auto____$2 = !((ch === ":"));if(and__4988__auto____$2)
...
{{
var G__12844 = (function (){sb.append(ch);
return sb;
})();
var G__12845 = cljs.reader.read_char.call(null,rdr);
sb = G__12844;
ch = G__12845;
continue;
}
...
{{
var G__12846 = cljs.reader.read_char.call(null,rdr);
ch = G__12846;
continue;
}
} else
...
var G__12847 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__12847;
continue;
}
} else
...
var G__12848 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__12848;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__5000__auto__ = (ch == null);if(or__5000__auto__)
{return or__5000__auto__;
} else
{var or__5000__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__5000__auto____$1)
{return or__5000__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__5000__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__5000__auto__))
{return or__5000__auto__;
} else
...
{{
var G__12849 = (function (){buffer.append(ch);
return buffer;
})();
var G__12850 = cljs.reader.read_char.call(null,reader);
buffer = G__12849;
ch = G__12850;
continue;
}
...
{if(("\\" === ch))
{{
var G__12851 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__12852 = cljs.reader.read_char.call(null,reader);
buffer = G__12851;
ch = G__12852;
continue;
}
...
{{
var G__12853 = (function (){buffer.append(ch);
return buffer;
})();
var G__12854 = cljs.reader.read_char.call(null,reader);
buffer = G__12853;
ch = G__12854;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__12856 = o;if(G__12856)
{var bit__5621__auto__ = (G__12856.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5621__auto__) || (G__12856.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__12856.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__12856);
} else
{return false;
}
}
...
{{
var G__12857 = reader;
var G__12858 = eof_is_error;
var G__12859 = sentinel;
var G__12860 = is_recursive;
reader = G__12857;
eof_is_error = G__12858;
sentinel = G__12859;
is_recursive = G__12860;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__12861 = cljs.reader.read_comment.call(null,reader,ch);
var G__12862 = eof_is_error;
var G__12863 = sentinel;
var G__12864 = is_recursive;
reader = G__12861;
eof_is_error = G__12862;
sentinel = G__12863;
is_recursive = G__12864;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__12865 = reader;
var G__12866 = eof_is_error;
var G__12867 = sentinel;
var G__12868 = is_recursive;
reader = G__12865;
eof_is_error = G__12866;
sentinel = G__12867;
is_recursive = G__12868;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__12871 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__12871,0,null);var years = cljs.core.nth.call(null,vec__12871,1,null);var months = cljs.core.nth.call(null,vec__12871,2,null);var days = cljs.core.nth.call(null,vec__12871,3,null);var hours = cljs.core.nth.call(null,vec__12871,4,null);var minutes = cljs.core.nth.call(null,vec__12871,5,null);var seconds = cljs.core.nth.call(null,vec__12871,6,null);var fraction = cljs.core.nth.call(null,vec__12871,7,null);var offset_sign = cljs.core.nth.call(null,vec__12871,8,null);var offset_hours = cljs.core.nth.call(null,vec__12871,9,null);var offset_minutes = cljs.core.nth.call(null,vec__12871,10,null);var v = vec__12871;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__5000__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__5000__auto__))
{return or__5000__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__5000__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__5000__auto__))
{return or__5000__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__5000__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__5000__auto__))
{return or__5000__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__5000__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__5000__auto__))
{return or__5000__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__5000__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__5000__auto__))
{return or__5000__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__5000__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__5000__auto__))
{return or__5000__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__5000__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__5000__auto__))
{return or__5000__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__5000__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__5000__auto__))
{return or__5000__auto__;
} else
{return 0;
}
...
{var vec__12873 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__12873,0,null);var months = cljs.core.nth.call(null,vec__12873,1,null);var days = cljs.core.nth.call(null,vec__12873,2,null);var hours = cljs.core.nth.call(null,vec__12873,3,null);var minutes = cljs.core.nth.call(null,vec__12873,4,null);var seconds = cljs.core.nth.call(null,vec__12873,5,null);var ms = cljs.core.nth.call(null,vec__12873,6,null);var offset = cljs.core.nth.call(null,vec__12873,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
