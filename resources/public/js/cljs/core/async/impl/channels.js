...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t39838 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t39838 = (function (val,box,meta39839){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t39838.cljs$lang$type = true;
cljs.core.async.impl.channels.t39838.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t39838";
cljs.core.async.impl.channels.t39838.cljs$lang$ctorPrWriter = (function (this__3824__auto__,writer__3825__auto__,opt__3826__auto__){return cljs.core._write(writer__3825__auto__,"cljs.core.async.impl.channels/t39838");
});
cljs.core.async.impl.channels.t39838.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t39838.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39840){var self__ = this;
var _39840__$1 = this;return self__.meta39839;
});
cljs.core.async.impl.channels.t39838.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39840,meta39839__$1){var self__ = this;
var _39840__$1 = this;return (new cljs.core.async.impl.channels.t39838(self__.val,self__.box,meta39839__$1));
});
cljs.core.async.impl.channels.__GT_t39838 = (function __GT_t39838(val__$1,box__$1,meta39839){return (new cljs.core.async.impl.channels.t39838(val__$1,box__$1,meta39839));
});
}
return (new cljs.core.async.impl.channels.t39838(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_39841 = self__.takes.pop();if((taker_39841 == null))
{} else
{if(taker_39841.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_39842 = taker_39841.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_39842,taker_39841){
return (function (){return (take_cb_39842.cljs$core$IFn$_invoke$arity$1 ? take_cb_39842.cljs$core$IFn$_invoke$arity$1(null) : take_cb_39842.call(null,null));
});})(take_cb_39842,taker_39841))
);
} else
{}
{
