...
hiccups.runtime.in_mode = (function in_mode(mode,f){var _STAR_html_mode_STAR_15559 = hiccups.runtime._STAR_html_mode_STAR_;try{hiccups.runtime._STAR_html_mode_STAR_ = mode;
return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_15559;
}});
/**
...
hiccups.runtime.render_attribute = (function render_attribute(p__15560){var vec__15562 = p__15560;var name = cljs.core.nth.call(null,vec__15562,0,null);var value = cljs.core.nth.call(null,vec__15562,1,null);if(value === true)
...
*/
hiccups.runtime.normalize_element = (function normalize_element(p__15563){var vec__15566 = p__15563;var tag = cljs.core.nth.call(null,vec__15566,0,null);var content = cljs.core.nthnext.call(null,vec__15566,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else
{}
var vec__15567 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));var _ = cljs.core.nth.call(null,vec__15567,0,null);var tag__$1 = cljs.core.nth.call(null,vec__15567,1,null);var id = cljs.core.nth.call(null,vec__15567,2,null);var class$ = cljs.core.nth.call(null,vec__15567,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),(cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,"."," "):null)], null);var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
*/
hiccups.runtime.render_element = (function render_element(element){var vec__15569 = hiccups.runtime.normalize_element.call(null,element);var tag = cljs.core.nth.call(null,vec__15569,0,null);var attrs = cljs.core.nth.call(null,vec__15569,1,null);var content = cljs.core.nth.call(null,vec__15569,2,null);if(cljs.core.truth_((function (){var or__4793__auto__ = content;if(cljs.core.truth_(or__4793__auto__))
