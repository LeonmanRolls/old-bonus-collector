...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t19931 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t19931 = (function (val,box,meta19932){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t19931.cljs$lang$type = true;
cljs.core.async.impl.channels.t19931.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t19931";
cljs.core.async.impl.channels.t19931.cljs$lang$ctorPrWriter = (function (this__8017__auto__,writer__8018__auto__,opt__8019__auto__){return cljs.core._write.call(null,writer__8018__auto__,"cljs.core.async.impl.channels/t19931");
});
cljs.core.async.impl.channels.t19931.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t19931.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19933){var self__ = this;
var _19933__$1 = this;return self__.meta19932;
});
cljs.core.async.impl.channels.t19931.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19933,meta19932__$1){var self__ = this;
var _19933__$1 = this;return (new cljs.core.async.impl.channels.t19931(self__.val,self__.box,meta19932__$1));
});
cljs.core.async.impl.channels.__GT_t19931 = (function __GT_t19931(val__$1,box__$1,meta19932){return (new cljs.core.async.impl.channels.t19931(val__$1,box__$1,meta19932));
});
}
return (new cljs.core.async.impl.channels.t19931(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8020__auto__,writer__8021__auto__,opts__8022__auto__){return cljs.core._write.call(null,writer__8021__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8017__auto__,writer__8018__auto__,opt__8019__auto__){return cljs.core._write.call(null,writer__8018__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_19934 = self__.takes.pop();if((taker_19934 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_19934))
{var take_cb_19935 = cljs.core.async.impl.protocols.commit.call(null,taker_19934);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_19935,taker_19934){
return (function (){return take_cb_19935.call(null,null);
});})(take_cb_19935,taker_19934))
);
} else
{}
{
