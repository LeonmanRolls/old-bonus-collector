...
;var seq__37081 = cljs.core.seq(pnod_col);var chunk__37082 = null;var count__37083 = 0;var i__37084 = 0;while(true){
if((i__37084 < count__37083))
{var pnod = chunk__37082.cljs$core$IIndexed$_nth$arity$2(null,i__37084);(func.cljs$core$IFn$_invoke$arity$2 ? func.cljs$core$IFn$_invoke$arity$2(pnod,partial_cback) : func.call(null,pnod,partial_cback));
{
var G__37088 = seq__37081;
var G__37089 = chunk__37082;
var G__37090 = count__37083;
var G__37091 = (i__37084 + 1);
seq__37081 = G__37088;
chunk__37082 = G__37089;
count__37083 = G__37090;
i__37084 = G__37091;
continue;
}
} else
{var temp__4092__auto__ = cljs.core.seq(seq__37081);if(temp__4092__auto__)
{var seq__37081__$1 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_(seq__37081__$1))
{var c__4004__auto__ = cljs.core.chunk_first(seq__37081__$1);{
var G__37092 = cljs.core.chunk_rest(seq__37081__$1);
var G__37093 = c__4004__auto__;
var G__37094 = cljs.core.count(c__4004__auto__);
var G__37095 = 0;
seq__37081 = G__37092;
chunk__37082 = G__37093;
count__37083 = G__37094;
i__37084 = G__37095;
continue;
}
} else
{var pnod = cljs.core.first(seq__37081__$1);(func.cljs$core$IFn$_invoke$arity$2 ? func.cljs$core$IFn$_invoke$arity$2(pnod,partial_cback) : func.call(null,pnod,partial_cback));
{
var G__37096 = cljs.core.next(seq__37081__$1);
var G__37097 = null;
var G__37098 = 0;
var G__37099 = 0;
seq__37081 = G__37096;
chunk__37082 = G__37097;
count__37083 = G__37098;
i__37084 = G__37099;
continue;
}
}
...
});if(typeof enfocus.effects.t37085 !== 'undefined')
{} else
{
/**
* @constructor
*/
enfocus.effects.t37085 = (function (trans,callback,func,chainable_effect,meta37086){
this.trans = trans;
...
enfocus.effects.t37085.cljs$lang$type = true;
enfocus.effects.t37085.cljs$lang$ctorStr = "enfocus.effects/t37085";
enfocus.effects.t37085.cljs$lang$ctorPrWriter = (function (this__3824__auto__,writer__3825__auto__,opt__3826__auto__){return cljs.core._write(writer__3825__auto__,"enfocus.effects/t37085");
});
enfocus.effects.t37085.prototype.enfocus$core$ITransform$ = true;
enfocus.effects.t37085.prototype.enfocus$core$ITransform$apply_transform$arity$2 = (function (_,nodes){var self__ = this;
...
enfocus.effects.t37085.prototype.enfocus$core$ITransform$apply_transform$arity$3 = (function (_,nodes,chain){var self__ = this;
...
enfocus.effects.t37085.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37087){var self__ = this;
var _37087__$1 = this;return self__.meta37086;
});
enfocus.effects.t37085.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37087,meta37086__$1){var self__ = this;
var _37087__$1 = this;return (new enfocus.effects.t37085(self__.trans,self__.callback,self__.func,self__.chainable_effect,meta37086__$1));
});
enfocus.effects.__GT_t37085 = (function __GT_t37085(trans__$1,callback__$1,func__$1,chainable_effect__$1,meta37086){return (new enfocus.effects.t37085(trans__$1,callback__$1,func__$1,chainable_effect__$1,meta37086));
});
}
return (new enfocus.effects.t37085(trans,callback,func,chainable_effect,null));
});
/**
...
chain.cljs$lang$applyTo = (function (arglist__37100){
var func = cljs.core.first(arglist__37100);
var chains = cljs.core.rest(arglist__37100);
...
var resize__5 = (function (wth,hgt,ttime,callback,accel){return enfocus.effects.chainable_effect((function (pnod,pcallback){var csize = goog.style.getContentBoxSize(pnod);var start = [csize.width,csize.height];var wth__$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$201,wth))?csize.width:wth);var hgt__$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$202,hgt))?csize.height:hgt);var end = [wth__$1,hgt__$1];var anim = (new goog.fx.dom.Resize(pnod,start,end,ttime,accel));if(cljs.core.truth_(pcallback))
{goog.events.listen(anim,goog.fx.Animation.EventType.END,pcallback);
} else
{}
return anim.play();
