...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_39797 = 0;while(true){
if((i_39797 < arr.length))
{(arr[i_39797] = null);
{
var G__39798 = (i_39797 + 1);
i_39797 = G__39798;
continue;
}
} else
...
{var i_39804 = (self__.level + 1);while(true){
if((i_39804 <= (new_level + 1)))
{(update[i_39804] = self__.header);
{
var G__39805 = (i_39804 + 1);
i_39804 = G__39805;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_39806 = 0;while(true){
if((i_39806 <= self__.level))
{var links_39807 = (update[i_39806]).forward;if(((links_39807[i_39806]) === x__$1))
{(links_39807[i_39806] = (x__$1.forward[i_39806]));
{
var G__39808 = (i_39806 + 1);
i_39806 = G__39808;
continue;
}
} else
{{
var G__39809 = (i_39806 + 1);
i_39806 = G__39809;
continue;
}
}
