...
hiccups.runtime._STAR_html_mode_STAR_ = cljs.core.constant$keyword$196;
hiccups.runtime.xml_mode_QMARK_ = (function xml_mode_QMARK_(){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(hiccups.runtime._STAR_html_mode_STAR_,cljs.core.constant$keyword$196);
});
hiccups.runtime.in_mode = (function in_mode(mode,f){var _STAR_html_mode_STAR_40592 = hiccups.runtime._STAR_html_mode_STAR_;try{hiccups.runtime._STAR_html_mode_STAR_ = mode;
return (f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_40592;
}});
/**
...
hiccups.runtime.render_attribute = (function render_attribute(p__40593){var vec__40595 = p__40593;var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40595,0,null);var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40595,1,null);if(value === true)
...
*/
hiccups.runtime.normalize_element = (function normalize_element(p__40596){var vec__40599 = p__40596;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40599,0,null);var content = cljs.core.nthnext(vec__40599,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else
{}
var vec__40600 = cljs.core.re_matches(hiccups.runtime.re_tag,hiccups.runtime.as_str(tag));var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40600,0,null);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40600,1,null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40600,2,null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40600,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$143,id,cljs.core.constant$keyword$193,(cljs.core.truth_(class$)?clojure.string.replace(class$,"."," "):null)], null);var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
...
*/
hiccups.runtime.render_element = (function render_element(element){var vec__40602 = hiccups.runtime.normalize_element(element);var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40602,0,null);var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40602,1,null);var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40602,2,null);if(cljs.core.truth_((function (){var or__3285__auto__ = content;if(cljs.core.truth_(or__3285__auto__))
