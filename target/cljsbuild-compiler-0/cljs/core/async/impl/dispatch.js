...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_23021 = 0;while(true){
var m_23022 = cljs.core.async.impl.dispatch.tasks.pop();if((m_23022 == null))
{} else
{(m_23022.cljs$core$IFn$_invoke$arity$0 ? m_23022.cljs$core$IFn$_invoke$arity$0() : m_23022.call(null));
if((count_23021 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__23023 = (count_23021 + 1);
count_23021 = G__23023;
continue;
}
} else
{}
