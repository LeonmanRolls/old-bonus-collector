...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__5539__auto__,writer__5540__auto__,opt__5541__auto__){return cljs.core._write.call(null,writer__5540__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_15539 = 0;while(true){
if((i_15539 < arr.length))
{(arr[i_15539] = null);
{
var G__15540 = (i_15539 + 1);
i_15539 = G__15540;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__5539__auto__,writer__5540__auto__,opt__5541__auto__){return cljs.core._write.call(null,writer__5540__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_15546 = (self__.level + 1);while(true){
if((i_15546 <= (new_level + 1)))
{(update[i_15546] = self__.header);
{
var G__15547 = (i_15546 + 1);
i_15546 = G__15547;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15548 = 0;while(true){
if((i_15548 <= self__.level))
{var links_15549 = (update[i_15548]).forward;if(((links_15549[i_15548]) === x__$1))
{(links_15549[i_15548] = (x__$1.forward[i_15548]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__5000__auto__ = (cljs.core.truth_((function (){var and__4988__auto__ = me;if(cljs.core.truth_(and__4988__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__4988__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__5000__auto__))
