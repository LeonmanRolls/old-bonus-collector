...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_22986 = 0;while(true){
if((i_22986 < arr.length))
{(arr[i_22986] = null);
{
...
{var i_22993 = (self__.level + 1);while(true){
if((i_22993 <= (new_level + 1)))
{(update[i_22993] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_22995 = 0;while(true){
if((i_22995 <= self__.level))
{var links_22996 = (update[i_22995]).forward;if(((links_22996[i_22995]) === x__$1))
{(links_22996[i_22995] = (x__$1.forward[i_22995]));
{
var G__22997 = (i_22995 + 1);
i_22995 = G__22997;
continue;
}
} else
{{
var G__22998 = (i_22995 + 1);
i_22995 = G__22998;
continue;
}
}
