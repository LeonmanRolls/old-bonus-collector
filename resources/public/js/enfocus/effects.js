...
;var seq__37595 = cljs.core.seq(pnod_col);var chunk__37596 = null;var count__37597 = 0;var i__37598 = 0;while(true){
if((i__37598 < count__37597))
{var pnod = chunk__37596.cljs$core$IIndexed$_nth$arity$2(null,i__37598);(func.cljs$core$IFn$_invoke$arity$2 ? func.cljs$core$IFn$_invoke$arity$2(pnod,partial_cback) : func.call(null,pnod,partial_cback));
{
var G__37602 = seq__37595;
var G__37603 = chunk__37596;
var G__37604 = count__37597;
var G__37605 = (i__37598 + 1);
seq__37595 = G__37602;
chunk__37596 = G__37603;
count__37597 = G__37604;
i__37598 = G__37605;
continue;
}
} else
{var temp__4092__auto__ = cljs.core.seq(seq__37595);if(temp__4092__auto__)
{var seq__37595__$1 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_(seq__37595__$1))
{var c__4004__auto__ = cljs.core.chunk_first(seq__37595__$1);{
var G__37606 = cljs.core.chunk_rest(seq__37595__$1);
var G__37607 = c__4004__auto__;
var G__37608 = cljs.core.count(c__4004__auto__);
var G__37609 = 0;
seq__37595 = G__37606;
chunk__37596 = G__37607;
count__37597 = G__37608;
i__37598 = G__37609;
continue;
}
} else
{var pnod = cljs.core.first(seq__37595__$1);(func.cljs$core$IFn$_invoke$arity$2 ? func.cljs$core$IFn$_invoke$arity$2(pnod,partial_cback) : func.call(null,pnod,partial_cback));
{
var G__37610 = cljs.core.next(seq__37595__$1);
var G__37611 = null;
var G__37612 = 0;
var G__37613 = 0;
seq__37595 = G__37610;
chunk__37596 = G__37611;
count__37597 = G__37612;
i__37598 = G__37613;
continue;
}
}
...
});if(typeof enfocus.effects.t37599 !== 'undefined')
{} else
{
/**
* @constructor
*/
enfocus.effects.t37599 = (function (trans,callback,func,chainable_effect,meta37600){
this.trans = trans;
...
enfocus.effects.t37599.cljs$lang$type = true;
enfocus.effects.t37599.cljs$lang$ctorStr = "enfocus.effects/t37599";
enfocus.effects.t37599.cljs$lang$ctorPrWriter = (function (this__3824__auto__,writer__3825__auto__,opt__3826__auto__){return cljs.core._write(writer__3825__auto__,"enfocus.effects/t37599");
});
enfocus.effects.t37599.prototype.enfocus$core$ITransform$ = true;
enfocus.effects.t37599.prototype.enfocus$core$ITransform$apply_transform$arity$2 = (function (_,nodes){var self__ = this;
...
enfocus.effects.t37599.prototype.enfocus$core$ITransform$apply_transform$arity$3 = (function (_,nodes,chain){var self__ = this;
...
enfocus.effects.t37599.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37601){var self__ = this;
var _37601__$1 = this;return self__.meta37600;
});
enfocus.effects.t37599.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37601,meta37600__$1){var self__ = this;
var _37601__$1 = this;return (new enfocus.effects.t37599(self__.trans,self__.callback,self__.func,self__.chainable_effect,meta37600__$1));
});
enfocus.effects.__GT_t37599 = (function __GT_t37599(trans__$1,callback__$1,func__$1,chainable_effect__$1,meta37600){return (new enfocus.effects.t37599(trans__$1,callback__$1,func__$1,chainable_effect__$1,meta37600));
});
}
return (new enfocus.effects.t37599(trans,callback,func,chainable_effect,null));
});
/**
...
chain.cljs$lang$applyTo = (function (arglist__37614){
var func = cljs.core.first(arglist__37614);
var chains = cljs.core.rest(arglist__37614);
...
var resize__5 = (function (wth,hgt,ttime,callback,accel){return enfocus.effects.chainable_effect((function (pnod,pcallback){var csize = goog.style.getContentBoxSize(pnod);var start = [csize.width,csize.height];var wth__$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$205,wth))?csize.width:wth);var hgt__$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$206,hgt))?csize.height:hgt);var end = [wth__$1,hgt__$1];var anim = (new goog.fx.dom.Resize(pnod,start,end,ttime,accel));if(cljs.core.truth_(pcallback))
{goog.events.listen(anim,goog.fx.Animation.EventType.END,pcallback);
} else
{}
return anim.play();
