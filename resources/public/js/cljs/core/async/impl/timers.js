...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3824__auto__,writer__3825__auto__,opt__3826__auto__){return cljs.core._write(writer__3825__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_40311 = 0;while(true){
if((i_40311 < arr.length))
{(arr[i_40311] = null);
{
var G__40312 = (i_40311 + 1);
i_40311 = G__40312;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3824__auto__,writer__3825__auto__,opt__3826__auto__){return cljs.core._write(writer__3825__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_40318 = (self__.level + 1);while(true){
if((i_40318 <= (new_level + 1)))
{(update[i_40318] = self__.header);
{
var G__40319 = (i_40318 + 1);
i_40318 = G__40319;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_40320 = 0;while(true){
if((i_40320 <= self__.level))
{var links_40321 = (update[i_40320]).forward;if(((links_40321[i_40320]) === x__$1))
{(links_40321[i_40320] = (x__$1.forward[i_40320]));
{
var G__40322 = (i_40320 + 1);
i_40320 = G__40322;
continue;
}
} else
{{
var G__40323 = (i_40320 + 1);
i_40320 = G__40323;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3285__auto__ = (cljs.core.truth_((function (){var and__3273__auto__ = me;if(cljs.core.truth_(and__3273__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3273__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3285__auto__))
