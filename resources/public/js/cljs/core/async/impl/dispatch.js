...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_39832 = 0;while(true){
var m_39833 = cljs.core.async.impl.dispatch.tasks.pop();if((m_39833 == null))
{} else
{(m_39833.cljs$core$IFn$_invoke$arity$0 ? m_39833.cljs$core$IFn$_invoke$arity$0() : m_39833.call(null));
if((count_39832 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__39834 = (count_39832 + 1);
count_39832 = G__39834;
continue;
}
} else
{}
