...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8017__auto__,writer__8018__auto__,opt__8019__auto__){return cljs.core._write.call(null,writer__8018__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_19890 = 0;while(true){
if((i_19890 < arr.length))
{(arr[i_19890] = null);
{
var G__19891 = (i_19890 + 1);
i_19890 = G__19891;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8017__auto__,writer__8018__auto__,opt__8019__auto__){return cljs.core._write.call(null,writer__8018__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_19897 = (self__.level + 1);while(true){
if((i_19897 <= (new_level + 1)))
{(update[i_19897] = self__.header);
{
var G__19898 = (i_19897 + 1);
i_19897 = G__19898;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_19899 = 0;while(true){
if((i_19899 <= self__.level))
{var links_19900 = (update[i_19899]).forward;if(((links_19900[i_19899]) === x__$1))
{(links_19900[i_19899] = (x__$1.forward[i_19899]));
{
var G__19901 = (i_19899 + 1);
i_19899 = G__19901;
continue;
}
} else
{{
var G__19902 = (i_19899 + 1);
i_19899 = G__19902;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7478__auto__ = (cljs.core.truth_((function (){var and__7466__auto__ = me;if(cljs.core.truth_(and__7466__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7466__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7478__auto__))
